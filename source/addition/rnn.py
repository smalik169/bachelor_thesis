...
def dynamic_rnn(cell, inputs, input_weights=None, sequence_length=None, initial_state=None,
  ...
  with vs.variable_scope(scope or "RNN") as varscope:
    ...
    (outputs, final_state) = _dynamic_rnn_loop(
        ...
        swap_memory=swap_memory, sequence_length=sequence_length, input_weights=input_weights)
...
def _dynamic_rnn_loop(
    ...
    sequence_length=None, input_weights=None):
  ...
  def _time_step(time, output_ta_t, *state):
    ...
    ######
    input_weight = array_ops.gather(input_weights,time) if input_weights is not None else None

    ######
    call_cell = lambda: cell(input_t, state, input_weight=input_weight)
