...
from tensorflow.python.ops.math_ops import sigmoid as sigm
...
MALIK_MONITOR_GATES = False
MALIK_GATE_LIST = []

sigmoid = lambda x: 1.2*sigm(x) - 0.1
#######################################
...
class BasicLSTMCell(RNNCell):
  ...
  def __call__(self, inputs, state, scope=None, input_weight=None):
